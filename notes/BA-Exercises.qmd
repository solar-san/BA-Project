...
* Take the `engel` data. Make a plot which shows the point estimate and bootstrap based intervals for the slope of different quantile regression models for values of $\tau$ = `seq(0.1, 0.9, by = 0.05)` (i.e. recreate the picture in slide 192). 
