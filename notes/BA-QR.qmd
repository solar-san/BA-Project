...
Note that, however, to formally test the equality of slopes we need a way to make _inference_.
...
$$
[\hat \theta - q_{1- \frac{\alpha}{2}} \times \mathrm{sd_{boot}}, 
\hat \theta + q_{1- \frac{\alpha}{2}} \times \mathrm{sd_{boot}}]
...
These tqo extremes denote the $\alpha/2$ and $1 - \alpha/2$ _empirical quantiles_ of the bootstrap estimates.